# Generated by Django 4.0.6 on 2022-10-23 21:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_granja', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TraceApp.proveedor')),
            ],
        ),
        migrations.CreateModel(
            name='Reporte',
            fields=[
                ...
                ('id_producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TraceApp.producto')),
            ],
        ),
        migrations.AddField(
            model_name='producto',
            name='id_res',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TraceApp.res'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comentarios', models.CharField(max_length=300)),
                ('id_producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TraceApp.producto')),
                ('id_receptor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TraceApp.proveedor')),
            ],
        ),
    ]
